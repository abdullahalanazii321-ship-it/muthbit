...
## المكدّس
- `apps/api` — Node 20 + Express + Knex + PostgreSQL 16. **جاهز ومختبر (٥٠ فحصاً ناجحاً). لا تعدّل أي ملف تحته إلا بطلب صريح مني.**
...
npm run api:test        # ٥٠ فحصاً — يجب أن تمر كلها
```
